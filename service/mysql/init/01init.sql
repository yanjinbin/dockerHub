...
CREATE
DATABASE  `dental_admin` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
CREATE
DATABASE  `dental_app` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
CREATE
DATABASE  `xxl_job` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- 授予权限
-- grant all PRIVILEGES on nacos.* to nacos@'%';
grant all PRIVILEGES on dental_admin.* to test_01@'%';
grant all PRIVILEGES on dental_app.* to test_01@'%';
